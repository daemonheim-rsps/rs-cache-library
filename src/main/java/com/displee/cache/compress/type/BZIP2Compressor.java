	...
	public static void decompress(BZIP2BlockEntry bzip2BlockEntry) {
		...
		while (bool_28_) {
			...
			for (int i_48_ = 0; i_48_ < i_36_; i_48_++) {
				...
				method145(bzip2BlockEntry.anIntArrayArray3095[i_48_], bzip2BlockEntry.anIntArrayArray3082[i_48_], bzip2BlockEntry.anIntArrayArray3099[i_48_], bzip2BlockEntry.aByteArrayArray3098[i_48_], i_49_, i_50_, i_35_);
			...
			while (i_64_ != i_52_) {
				if (i_64_ == 0 || i_64_ == 1) {
					...
					i_65_++;
					i_30_ = (bzip2BlockEntry.aByteArray3107[(bzip2BlockEntry.aByteArray3101[bzip2BlockEntry.anIntArray3092[0]] & 0xff)]);
